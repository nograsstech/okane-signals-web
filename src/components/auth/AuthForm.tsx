  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="mb-8 text-center">
        ...
        <h1 className="text-2xl font-bold tracking-tight mb-2">{titles[currentMode]}</h1>
        <p className="text-sm text-foreground/60 font-mono">{subtitles[currentMode]}</p>
      </div>
      ...
      <div className="relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 p-6 bg-background/30 border border-border/30">
          {errors.form && (
          ...
          {currentMode !== 'forgot' && (
            <div className="space-y-1">
              ...
              {errors.password && (
                <span className="text-xs text-destructive font-mono">{errors.password}</span>
              )}
            </div>
          )}
